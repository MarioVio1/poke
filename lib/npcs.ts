...
export const NPCs: Record<string, NPCData> = {
  ...
  prof_barcaro: {
    ...
    role: 'Scientist',
    dialog: [
      'Uè bocia! Mi son el Prof. GheSboro!',
      'Vardame ben: studio i Bestie da 40 anni e me xe restà anca i cavei!',
      'In sta valigetta ghe xe el futuro de Venetia. Scegli el tuo primo Bestie!',
      'E ocio, che se te lo tratti mal te mando in mona!',
    ],
    sprite: 'professor',
    gift: 'starter',
  },
  mamma: {
    ...
    role: 'Mom',
    dialog: [
      'Amore de mamma! Te seti sveià finalmente?',
      'Va pian col Bestidex e soratuto... magna!',
      'Te go messo un goto de graspa nel zaino, se te ghè freddo.',
      'Se te perdi, torna a casa che te fasso el risi e bisi!',
    ],
    sprite: 'mom',
  },
  nonno_piero: {
  ...
  gondoliere_nero: {
    ...
    role: 'Boatman',
    dialog: [
      'Vogando par i canali, vogando... e tirando do porchi!',
      'Voi traversar? Costa 80€ parchè te seti un foresto de Mestre!',
      'Ma chi te credi de esser? El Doge? Lu el pagava in sghèi, ti te me pari un po\' in bolletta!',
      'Ocio ai pantegani in canal, i xe grossi come Bestie!',
    ],
    sprite: 'gondolier',
  },
  pizzard_忘掉: {
  ...
  bepi_spritzaro: {
    ...
    role: 'Gym Leader',
    dialog: [
      'VANTI COL SPRITZ! CHE BEVEMO OGGI?!',
      'El mio Spritzino el spara fiamme che gnanca el Vesuvio!',
      'Lotemo par el Badge! Ma se te perdi, te me paghi un giro de ombre!',
    ],
  ...
  vecchia_spritzia: {
    ...
    role: 'Old Lady',
    dialog: [
      'Ai me tempi i bocia i laorava in campagna, mica i coreva drio a sti pokemon de fero!',
      'Magnate un poco de polenta e osei che te seti un stichetto!',
      'Bevi acqua de fonte, non spritz! ...Scherzavo, dame un goto de bianco anca a mi!',
      'Ghe sboro, che bel moroso che te seti diventà! Te par proprio un Doge.',
    ],
    sprite: 'lady',
  },
  vecio_ghetto: {
    id: 'vecio_ghetto',
    name: 'Vecio del Ghetto',
    role: 'Elder',
    dialog: [
      'Varda che bel che xe el Leon de San Marco!',
      'Se te vardi ben i so oci, te vedi el futuro de Venetia.',
      'I Bestie i xe nati qua, tra el fango de la laguna e el sal de mar.',
      'Ocio che el ponte de Rialto el casca se te salti massa!',
    ],
    sprite: 'old_man',
  },
